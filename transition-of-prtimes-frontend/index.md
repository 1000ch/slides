...
- 起案のフォーマットとし議論を繰り返す。これで議論の質が徐々に向上
...
- 終わりのないルールの議論に時間を割いていた [ESLint を脱却し xo へ移行](https://developers.prtimes.jp/2024/02/09/frontend-lint-tools-unified-xo/)
...
- 仲間も増えて Frontend という領域が確立し、Backend との相互交流が活発化
  - [バックエンドエンジニアから見たフロントエンド開発の魅力と学び](https://developers.prtimes.jp/2024/09/06/frontend-challenge-learnings/)
  - [フロントエンドエンジニアがバックエンド開発に挑戦して得た学び](https://developers.prtimes.jp/2024/11/12/backend-challenge-learnings/)
